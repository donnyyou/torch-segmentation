...
DATA_DIR="/home/donnyyou/Datasets/Cityscapes"

BACKBONE="deepbase_resnet50_d8"
MODEL_NAME="deeplabv3"
CHECKPOINTS_NAME="fs_deeplabv3_cityscapes_seg"$2
PRETRAINED_MODEL="./pretrained_models/3x3resnet50-imagenet.pth"

CONFIG_FILE='configs/cityscapes/base_fcn_cityscapes_seg.conf'
MAX_ITERS=40000
LOSS_TYPE="dsnohemce_loss"

LOG_DIR="./log/cityscapes/"
