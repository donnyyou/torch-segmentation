...
from tools.fcn_segmentor import FCNSegmentor
from tools.fcn_segmentor_test import FCNSegmentorTest
...
if __name__ == "__main__":
    ...
    if configer.get('phase') == 'train':
        ...
        runner = FCNSegmentorTest(configer)
